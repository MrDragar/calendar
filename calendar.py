...
class Ui_Calendar(object):
    def setupUi(self, Calendar):
        ...
        Calendar.resize(900, 700)
        Calendar.setStyleSheet("\n"
"background-color:qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgb(98, 160, 234), stop:1 rgb(153, 193, 241));\n"
"")
...
"border: none;")
        ...
        self.label_moun = QtWidgets.QLabel(self.centralwidget)
        self.label_moun.setGeometry(QtCore.QRect(310, 220, 250, 71))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setKerning(True)
        self.label_moun.setFont(font)
        self.label_moun.setStyleSheet("background-color:rgb(255, 255, 255);\n"
"border: none;\n"
"text-align: сenter;")
        self.label_moun.setObjectName("label_moun")
...
"")
    ...
    def retranslateUi(self, Calendar):
        ...
        self.label_moun.setText(_translate("Calendar", "Май"))
